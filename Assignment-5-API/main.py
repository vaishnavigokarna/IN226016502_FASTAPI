...
def search_orders(
    ...
    results = [
         o for o in orders if customer_name.lower() 
         in o['customer_name'].lower() 
         ] 
    if not results: 
        return {
...
# Endpoint --- GET /products/sort-by-category
